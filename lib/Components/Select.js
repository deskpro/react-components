...
var DpMultiselect = (_temp = _class = function (_React$Component) {
  _inherits(DpMultiselect, _React$Component);

  function DpMultiselect(props) {
    _classCallCheck(this, DpMultiselect);

    var _this = _possibleConstructorReturn(this, (DpMultiselect.__proto__ || Object.getPrototypeOf(DpMultiselect)).call(this, props));

    _this.handleChange = function (value, added) {
...
var Select = (_temp3 = _class2 = function (_React$Component2) {
  ...
  function Select() {
    ...
    return _ret = (_temp2 = (_this3 = _possibleConstructorReturn(this, (_ref = Select.__proto__ || Object.getPrototypeOf(Select)).call.apply(_ref, [this].concat(args))), _this3), _this3.handleChange = function (value) {
